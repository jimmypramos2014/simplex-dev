...
class DetalleProformaEntregaDatosEnvioType extends AbstractType
{
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'AppBundle\Entity\DetalleProformaEntregaDatosEnvio',
            'empresa'    => '',
    ...
    {
        return 'appbundle_detalleproformaentregadatosenvio';
    }
