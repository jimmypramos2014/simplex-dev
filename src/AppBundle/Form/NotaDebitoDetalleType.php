...
class NotaDebitoDetalleType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('notaDebito',EntityType::class,array(
                'class' => 'AppBundle:NotaDebito',
                'label'         => false,
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'AppBundle\Entity\NotaDebitoDetalle'
        ));
    }
    ...
    {
        return 'appbundle_notadebitodetalle';
    }
