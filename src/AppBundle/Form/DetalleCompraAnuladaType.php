...
class DetalleCompraAnuladaType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('detalleCompra',EntityType::class,array(
                'attr'          => array('class' => 'form-control d-none'),
                'class'         => 'AppBundle:DetalleCompra',
                'label'         => false,
                'required'      => true,
                'data'          => $this->em->getRepository('AppBundle:DetalleCompra')->find($options['detalle_compra_id'])  
                ))
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'AppBundle\Entity\DetalleCompraAnulada',
    ...
    {
        return 'appbundle_detallecompraanulada';
    }
