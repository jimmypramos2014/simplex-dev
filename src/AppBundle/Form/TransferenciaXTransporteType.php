...
class TransferenciaXTransporteType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('transferencia_id',HiddenType::class,array(
                'attr'      => array('class' => 'form-control'),
                'data'      => '',
                'mapped'    => false,
                'required'  => false,
                ))
            ->add('tipoGuia',ChoiceType::class,array(
                'attr'          => array('class' => 'form-control'),
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'AppBundle\Entity\TransferenciaXTransporte',
            'empresa'    => '',
    ...
    {
        return 'appbundle_transferenciaxtransporte';
    }
